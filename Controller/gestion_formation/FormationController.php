...
include_once(__DIR__ . '/../../Model/gestion_formation/formation.php');
    ...
    public function listFormationsPaginated($limit, $offset, $search = "")
{
    ...
    public function searchActivePaginated($search = "", $page = 1, $limit = 9, $sort = "ASC")
    {
        ...
        $sqlCount = "SELECT COUNT(*) FROM formation
                     WHERE etat = 'active'
                     AND (titre LIKE :search OR nom_propr LIKE :search)";
    ...
    public function searchActiveByUser($search = "", $userId, $page = 1, $limit = 9, $sort = "ASC")
    {
        $db = config::getConnexion();
