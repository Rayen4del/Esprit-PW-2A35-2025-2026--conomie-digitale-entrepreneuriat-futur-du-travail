                ...
                <div class="list-group mb-4">
                  ...
                  <?php else: ?>
                    ...
                    <?php if (($_SESSION['user_type'] ?? '') === 'admin'): ?>
                      <a href="../BackOffice/Formation/consulterformations.php" class="list-group-item list-group-item-action">
                        <i class="bx bx-shield me-2"></i> Interface Admin
                      </a>

                      <a href="interfacesuperutilisateur.php"
...
window.openView = function (id) {
    ...
    btnChapitre.href = "../ajouterchapitre.php?id=" + id;
    btnTest.href = "../ajoutertest.php?id=" + id;

    fetch("viewformation1.php?id=" + id + "&ajax=1")
        .then(res => res.text())
        .then(data => {
