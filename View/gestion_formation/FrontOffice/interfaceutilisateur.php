...
if (isset($_SESSION['user_id'])) {
    $progressData = $progressC->getProgressionByUser($_SESSION['user_id']);
}
...
>
  ...
  <div class="offcanvas-body">
    ...
    <div class="list-group">
      ...
      <?php endif; ?>
        <a href="generateurf/generater.php"
        class="list-group-item list-group-item-action text-primary">
        <i class="bx bx-brain me-2"></i> Générateur IA
      </a>
    </div>
    <hr>
      ...
      <hr>
          <div class="col-lg-12">
              <small class="text-light fw-semibold">📊 Mes Formations</small>
              ...
              <div class="demo-inline-spacing mt-3">
                <ul class="list-group">
                  ...
                  <?php if (!empty($progressData)): ?>
                    ...
                    <?php foreach ($progressData as $f): 
                        $percent = ($f['total_chapitres'] > 0)
                            ? ($f['chapitres_finis'] / $f['total_chapitres']) * 100
                            : 0;
                        $isFinished = ($f['total_chapitres'] > 0 && $f['chapitres_finis'] == $f['total_chapitres']);
                    ?>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div style="width:70px; height:70px;">
                        <img 
                          src="<?= UPLOAD_URL . htmlspecialchars($f['image'] ?? 'default.png') ?>"
                      ...
                      <div class="flex-grow-1 p-2">
                        ...
                        <div class="d-flex justify-content-between">
                          ...
                          <small class="text-muted">📅 <?= $f['derniere_date'] ?? '-' ?></small>
                        </div>

                      </div>

                      <?php 
                        $isFinished = ($f['total_chapitres'] > 0 
                            && $f['chapitres_finis'] == $f['total_chapitres']);
                      ?>
          ...
          <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                     ...
                     <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <!-- BOUTON -->
                        <?php if (isset($_SESSION['user_type']) && in_array($_SESSION['user_type'], ['admin', 'super'])): ?>
                            <a href="interfacesuperutilisateur.php" class="btn btn-primary">
...
<div class="modal fade" id="calendarModal" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5>📅 Choisir des dates pour cette formation</h5>
        <button class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <button class="btn btn-success mb-3" onclick="addDate()">
          ➕ Ajouter date
        </button>
...
function loadPage(page = 1) {
  ...
  $("#tableBody").load(
    "searchformationutilisateur.php?page=" + page + "&search=" + search
  );
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: 'getPlanning.php',

        eventClick: function(info) {

            let action = prompt(
                "Choisir une action :\n\n" +
                "1 = Ajouter / modifier note\n" +
            ...
            if (action === "1") {
                ...
                let note = prompt("📝 Ajouter / modifier note :", info.event.extendedProps.note || "");
            ...
            // ================= DELETE =================
                ...
                if (confirm("❌ Supprimer ce planning ?")) {
                    ...
                    .then(res => res.text())
                    .then(() => {
                        info.event.remove(); // 🔥 suppression directe UI
...
function resetProgress(formationId) {

    fetch("resetProgress.php", {
        method: "POST",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
        },
        body: "formation_id=" + formationId
    })
    .then(res => res.text())
    .then(data => {
