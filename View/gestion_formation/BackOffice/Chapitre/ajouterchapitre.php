...
/* =========================
   FORMATION SELECTIONNÉE (GET)
========================= */
$id_f_selected = isset($_GET['id']) ? (int) $_GET['id'] : 0;

$ordre = 1;

if ($id_f_selected > 0) {
    $lastOrder = $chapitreC->getLastOrderByFormation($id_f_selected);
    $ordre = $lastOrder ? $lastOrder + 1 : 1;
}
...
========================= */
if (
    isset($_POST["id_f"], $_POST["titre_c"]) &&
    !empty($_POST["id_f"]) &&
    !empty($_POST["titre_c"])
) {
    $id_f = (int) $_POST["id_f"];
    ...
    header('Location: ajouterchapitre.php?id=' . $id_f);
    exit;
}
?>
<!DOCTYPE html>
                  ...
                  <div class="col-12">
                    <div class="card mb-4">
                      <div class="card-header">
                        <h5 class="mb-0">Ajouter Chapitre</h5>
                      </div>
                      ...
                      <div class="card-body">
                       ...
                       <form method="POST" id="chapitreForm">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" name="titre_c" id="titre_c" class="form-control">
                          ...
                          <div class="mb-3">
                            ...
                            <span id="errFormation" class="text-danger small"></span>
                          </div>

                          <div class="mb-3">
                            <label class="form-label">Ordre</label>
                            <input type="number" name="ordre" id="ordre" class="form-control" readonly>
                            <span id="errOrdre" class="text-danger small"></span>
                          </div>
