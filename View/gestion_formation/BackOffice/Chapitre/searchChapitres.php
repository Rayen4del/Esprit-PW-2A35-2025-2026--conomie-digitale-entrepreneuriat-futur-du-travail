...
$limit = 10;
$sort = $_GET['sort'] ?? 'ASC';
$idfor = !empty($_GET['id_f']) ? $_GET['id_f'] : null;
$result = $chapitreC->searchPaginated($idfor,$search, $page, $limit, $sort);
      ...
      <td class="text-end">
        ...
        <div class="d-flex justify-content-end gap-2">
         ...
         <button 
            ...
            onclick='openEdit(<?= json_encode($row, JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'>
            Edit
        </button>
