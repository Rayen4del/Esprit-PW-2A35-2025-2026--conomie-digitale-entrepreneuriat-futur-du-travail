                    ...
                    <div class="d-flex justify-content-between mb-3">
                      ...
                      <div class="d-flex gap-2 align-items-center">
                        ...
                        <form method="GET" class="d-flex">
                          ...
                          <select name="id_f" class="form-select me-2">
                            <option value="">Toutes formations</option>

                            <?php foreach ($formations as $f): ?>
                              <option value="<?= $f['id_f'] ?>"
                                <?= (isset($_GET['id_f']) && $_GET['id_f'] == $f['id_f']) ? 'selected' : '' ?>>
                                <?= $f['id_f'] . ' | ' . $f['titre'] ?>
                              </option>
                            <?php endforeach; ?>
...
<!-- ================= EDIT MODAL ================= -->
<div class="modal fade" id="modalEditChapitre" tabindex="-1">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="updatechapitre.php">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="edit_id" name="id_c">

          <label class="form-label">Titre</label>
          <input type="text" class="form-control mb-2" id="edit_titre" name="titre_c">

          <label class="form-label">Ordre</label>
          <input type="number" class="form-control mb-2" id="edit_ordre" name="ordre">

          <label class="form-label">Formation</label>
          <input type="number" class="form-control mb-2" id="edit_idf" name="id_f">
