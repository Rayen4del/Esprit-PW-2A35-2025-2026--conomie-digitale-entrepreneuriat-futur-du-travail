          ...
          <!-- Navbar -->
            ...
            <div class="offcanvas-body">
                ...
                <img
                    ...
                    console.log('Fetched HTML contains', scripts.length, 'script tags');
                    Array.from(scripts).forEach((s, idx) => {
                />
                ...
                <a href="/skiller6/View/BackOffice/gestionformation/consulterformations.php" class="list-group-item list-group-item-action">
                    <i class="bx bx-user me-2"></i> interface admin
                          newScript.onload = () => console.log('Loaded external script', src);
                          newScript.onerror = () => console.warn('Failed to load script', src);
                </a>
