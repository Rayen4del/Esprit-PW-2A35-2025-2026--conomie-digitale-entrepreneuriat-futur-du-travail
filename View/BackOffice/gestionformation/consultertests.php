...
>
  ...
  <div class="offcanvas-body">
          ...
          <div class="content-wrapper">
           <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                Gestion Formations / Consulter Tests
              </h4>
              ...
              <div class="card p-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                  ...
                  <div>
                    ...
                    <a href="ajoutertest.php" class="btn btn-primary">
                      Ajouter
                    </a>
    ...
    <!-- ============ VIEW MODAL ============ -->
<div class="modal fade" id="modalViewTest">
...
<!-- ============ EDIT MODAL ============ -->
<div class="modal fade" id="modalEditTest">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="updatetest.php">
        ...
        <input type="hidden" name="id_t" id="edit_id">

        <div class="modal-body">

          <label>Chapitre ID</label>
          <input type="number" class="form-control mb-2" name="id_c" id="edit_idc">

          <label>Formation ID</label>
          <input type="number" class="form-control mb-2" name="id_f" id="edit_idf">

          <label>Score minimum</label>
          <input type="number" class="form-control mb-2" name="score_min" id="edit_score">

          <label>Date création</label>
          <input type="date" class="form-control mb-2" name="date_creation" id="edit_date">
...
<script src="consultertests.js"></script>
</body>
</html>
