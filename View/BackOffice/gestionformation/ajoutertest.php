                    ...
                    <div class="col-12">
                      <div class="card shadow-sm mb-4">
                        <div class="card-header bg-white">
                          <h5 class="mb-0">➕ Ajouter un test</h5>
                        </div>
                          ...
                          <form method="POST">
                            ...
                            <div class="mb-4">
                              ...
                              <div class="d-flex gap-4 mt-2">
                                ...
                                <div class="form-check">
                                  ...
                                  <label class="form-check-label" for="niveau">Test / Niveau</label>
                                </div>

                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="type_test" value="quiz" id="quiz">
                                  <label class="form-check-label" for="quiz">Quiz / Compréhension</label>
                                </div>
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-6">
                                ...
                                <select class="form-select shadow-sm" name="id_f" id="formationSelect">
                              ...
                              <div class="col-md-6">
                                ...
                                <select class="form-select shadow-sm" name="id_c" id="chapitreSelect">
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="number" name="score_min" class="form-control shadow-sm" placeholder="Ex: 10" min="0">
                              </div>
                      ...
                      <div class="card shadow-sm">
                        ...
                        <div class="card-header bg-white">
                          <h5 class="mb-0">🧠 Ajouter des questions</h5>
                        </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="mb-3">
                            ...
                            <select id="testSelect" class="form-select shadow-sm">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" id="count" class="form-control shadow-sm" min="1">
                          </div>

                          <button type="button" class="btn btn-outline-primary mb-3" onclick="generate()">
                            Générer questions
                          </button>
                          ...
                          <form method="POST">
                            ...
                            <div class="text-end mt-3">
                              <button type="submit" name="save_questions" class="btn btn-success px-4">
                                Enregistrer
                              </button>
                            </div>
