...
>
  ...
  <div class="offcanvas-body">
    ...
    <div class="list-group">
                  <a href="/skiller6/View/BackOffice/gestionformation/consulterformations.php" class="list-group-item list-group-item-action">
                    <i class="bx bx-user me-2"></i> interface admin
                </a>

                <a href="/skiller6/View/FrontOffice/gestionformation/interfaceutilisateur.php" class="list-group-item list-group-item-action">
                    <i class="bx bx-cog me-2"></i> interface user
                </a>
