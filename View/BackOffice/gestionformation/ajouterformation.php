...
if (
    ...
    if (
        ...
        // 📁 dossier upload
        $targetDir = defined('UPLOADS_DIR') ? UPLOADS_DIR : __DIR__ . "/../../../uploads/";
        ...
        // 🔥 nom unique
        $fileName = date('Ymd_His') . '_' . bin2hex(random_bytes(3)) . '.' . $extension;

        $targetFile = $targetDir . $fileName;

        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
          $imagePath = (defined('UPLOADS_URL') ? UPLOADS_URL : 'uploads/') . $fileName;
        } else {
        ...
        $formation = new Formation(
            ...
            $_POST['titre'],
            $_POST['description'],
            1, // 🔥 createdBy par défaut
            $_POST['nomProprietaire'],
            new DateTime(), // 🔥 date auto
            0, // 🔥 evaluation auto
            $imagePath,
            $_POST['etat']
        );
...
<!-- Content wrapper -->
        <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">gestion formations /</span> ajouter formation</h4>
                            <div class="row">
                    ...
                    <div class="card-body">
                     <form method="POST" enctype="multipart/form-data" id="formationForm">
                          ...
                          <div class="mb-3">
                              ...
                              <small class="text-danger" id="errTitre"></small>
                          </div>
                          ...
                          <div class="mb-3">
                              ...
                              <input type="text" name="nomProprietaire" id="nomProprietaire" class="form-control">
                          ...
                          <div class="mb-3">
                              ...
                              <div id="dropZone" class="border p-3 text-center rounded">
                                  <p class="mb-2">Glisse ou clique pour ajouter une image</p>
                                  <input type="file" name="image" id="imageInput" hidden accept="image/*">
                              </div>

                              <img id="preview" class="mt-2 rounded shadow" style="max-width:150px; display:none;">

                              <small class="text-danger" id="errImage"></small>
                          </div>
                          ...
                          <div class="mb-3">
                              ...
                              <small class="text-danger" id="errEtat"></small>
                          </div>
...
<!-- / Layout container ------------------------------------------------------------------------------------------------->
   ...
   <script src="ajouterformation.js"></script>
</div>
  </div>
</div>
</div>
