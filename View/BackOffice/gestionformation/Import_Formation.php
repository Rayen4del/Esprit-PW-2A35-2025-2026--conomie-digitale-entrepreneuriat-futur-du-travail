<?php
include __DIR__ . '/../../../Controller/ImportController.php';
...
if (isset($_POST["url"]) && !empty($_POST["url"])) {
    ...
    try {
        $importC->importFromUrl($url, $etat);
...
<!-- Content wrapper -->
    ...
    <!-- URL SOURCE -->
    <div class="mb-3">
        <label class="form-label">URL de la formation</label>
        <input type="text" name="url" id="url" class="form-control" placeholder="https://example.com/course">
        <small class="text-danger" id="errUrl"></small>
    </div>
