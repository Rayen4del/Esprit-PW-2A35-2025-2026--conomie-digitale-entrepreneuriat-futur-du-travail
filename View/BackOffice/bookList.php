                  ...
                  <table class="table top-selling-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <p class="text-sm"><?php echo $book['publicationDate']; ?></p>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="action justify-content-end">
                            ...
                            <a href="deleteBook.php?id=<?php echo $book['id']; ?>" class="more-btn ml-10" onclick="return confirm('Are you sure you want to delete this book?')">
