...
if (
    isset($_POST["title"]) && isset($_POST["author"]) && isset($_POST["publicationDate"]) && isset($_POST["language"]) && isset($_POST["status"]) && isset($_POST["copies"]) && isset($_POST["category"])
) {
    if (
        !empty($_POST["title"]) && !empty($_POST["author"]) && !empty($_POST["publicationDate"]) && !empty($_POST["language"]) && !empty($_POST["status"]) && !empty($_POST["copies"]) && !empty($_POST["category"]) 
    ) {
        $book = new Book(
            null, // id
            $_POST['title'],
    ...
    <path
      ...
      fill="red" />
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="index.html" class="active"> Book Store </a>
              </li>
            </ul>
          </li>
           <li class="nav-item nav-item-has-children">
        ...
        <form action="" method="POST">
          ...
          <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="langAN" name="language" value="AN">
              <label class="form-check-label" for="langAN">AN</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="langFR" name="language" value="FR">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="copies" name="copies" placeholder="Enter number of copies" min="1" required>
          </div>
