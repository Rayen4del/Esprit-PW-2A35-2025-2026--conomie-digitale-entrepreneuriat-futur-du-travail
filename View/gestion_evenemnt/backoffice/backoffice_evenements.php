  ...
  <div class="navbar-nav-right d-flex align-items-center w-100" id="navbar-collapse">
    ...
    <div class="navbar-nav align-items-center flex-grow-1">
      <div class="nav-item d-flex align-items-center w-100">
        ...
        <form method="GET"
              action="/projet/view/evenement/html/backoffice/backoffice_evenements.php"
              id="searchForm"
...
<!-- Menu sidebar (IMPORTANT pour flèches) -->
...
<!-- Bootstrap bundle CDN (optionnel mais utile pour offcanvas/modal) -->
