document.addEventListener("DOMContentLoaded", function () {
  ...
  const chapitreInput = document.querySelector('input[name="chapid"]');
  const chapitre_id = chapitreInput ? chapitreInput.value : null;
  ...
  try {
    const res = await fetch("save_contenu.php", {
      method: "POST",
      body: fd
    });
