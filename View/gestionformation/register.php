...
if (isset($_POST['submit'])) {
    ...
    if ($nom && $prenom && $email && $password) {
        ...
        $check = $pdo->prepare("SELECT id_u FROM utilisateur WHERE email = ?");
        $check->execute([$email]);
        ...
        if ($check->rowCount() > 0) {
            ...
            $sql = "INSERT INTO utilisateur (nom, prenom, email, password, type)
                    VALUES (?, ?, ?, ?, ?)";
...
>
  <head>
    ...
    <link rel="stylesheet" href="assestsjs/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="assetsjs/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
