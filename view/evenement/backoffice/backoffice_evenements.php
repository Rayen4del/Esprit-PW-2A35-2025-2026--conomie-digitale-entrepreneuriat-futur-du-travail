    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item open">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/projet/view/evenement/backoffice/backoffice_evenements.php" class="menu-link active">
                <i class="bi bi-grid-3x3 menu-icon"></i> Événements
              </a>
            </li>
            <li class="menu-item">
              <a href="/projet/view/evenement/backoffice/statistics_dashboard.php" class="menu-link">
    ...
    <div class="layout-page">
      ...
      <nav class="layout-navbar">
        <div class="navbar-search">
          <form method="GET" action="/projet/view/evenement/backoffice/backoffice_evenements.php" id="searchForm">
      ...
      <div class="content-wrapper">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="GET" action="/projet/view/evenement/backoffice/backoffice_evenements.php" id="filterForm">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <a href="/projet/view/evenement/backoffice/backoffice_evenements.php" class="btn btn-outline-secondary w-100">
...
function openDeleteModal(id, title) {
    ...
    document.getElementById('deleteConfirmBtn').href = `/projet/view/evenement/backoffice/backoffice_evenements.php?delete_id=${id}`;
