    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item open">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/projet/view/evenement/backoffice/backoffice_evenements.php" class="menu-link">
                <i class="bi bi-grid-3x3 menu-icon"></i> Événements
              </a>
            </li>
            <li class="menu-item">
              <a href="/projet/view/evenement/backoffice/statistics_dashboard.php" class="menu-link active">
