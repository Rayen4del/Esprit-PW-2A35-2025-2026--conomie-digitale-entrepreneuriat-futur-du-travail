    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item open">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/projet/view/evenement/frontoffice/liste_evenements.php" class="menu-link">
                <i class="bi bi-list-ul menu-icon"></i> Liste
              </a>
            </li>
            <li class="menu-item">
              <a href="/projet/view/evenement/frontoffice/form_evenement.php" class="menu-link active">
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="alert alert-success d-flex align-items-center gap-2" role="alert">
          ...
          <div>Événement publié avec succès ! <a href="/projet/view/evenement/frontoffice/liste_evenements.php" class="alert-link">Voir la liste →</a></div>
        </div>
        <?php endif; ?>
...
<script src="/projet/view/evenement/frontoffice/js/form_validation.js"></script>
<script>
