...
function renderEvents($events) {
    ...
    if (empty($events)): ?>
        <div class="text-center py-5">
          ...
          <a href="/projet/view/evenement/frontoffice/form_evenement.php" class="btn btn-primary mt-2">
              ...
              <div class="card-body pt-2">
                ...
                <div class="d-flex gap-2">
                  ...
                  <a class="btn btn-sm btn-outline-info flex-fill"
                     href="/projet/view/evenement/frontoffice/export_event_registrations.php?event_id=<?= $ev['ID'] ?>"
                     target="_blank"
...
function renderPagination($currentPage, $totalPages, $search, $statut, $type) {
    ...
    $baseUrl = '/projet/view/evenement/frontoffice/liste_evenements.php';
    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item open">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/projet/view/evenement/frontoffice/liste_evenements.php" class="menu-link active">
                <i class="bi bi-list-ul menu-icon"></i> Liste
              </a>
            </li>
            <li class="menu-item">
              <a href="/projet/view/evenement/frontoffice/form_evenement.php" class="menu-link">
    ...
    <div class="layout-page">
      ...
      <nav class="layout-navbar">
        <div class="navbar-search">
          <form method="GET" action="/projet/view/evenement/frontoffice/liste_evenements.php" id="searchForm">
      ...
      <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
          ...
          <a href="/projet/view/evenement/frontoffice/form_evenement.php" class="btn btn-primary btn-sm">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="GET" action="/projet/view/evenement/frontoffice/liste_evenements.php" id="filterForm">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <a href="/projet/view/evenement/frontoffice/liste_evenements.php" class="btn btn-outline-secondary w-100">
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editForm" method="POST" action="/projet/view/evenement/frontoffice/liste_evenements.php" novalidate>
...
<script src="/projet/view/evenement/frontoffice/js/common.js"></script>
<script src="/projet/view/evenement/frontoffice/js/validate_rules.js"></script>
<script src="/projet/view/evenement/frontoffice/js/list_validation.js"></script>
<script>
// Open map modal
...
setupDirectionsButton();
    ...
    function openDeleteModal(id, title) {
        ...
        document.getElementById('deleteConfirmBtn').href =
            '/projet/view/evenement/frontoffice/liste_evenements.php?delete_id=' + id;
