                ...
                <td>
                  <div class="action-buttons">
                    ...
                    <button type="button"
                            ...
                            data-id="<?= intval($row['ID']) ?>"
                            data-title="<?= htmlspecialchars($row['Titre'], ENT_QUOTES) ?>">
  ...
  <div class="layout-container">
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li><a href="/projet/view/evenement/frontoffice/user_events.php" class="menu-link"><i class="bi bi-calendar-event menu-icon"></i> Événements</a></li>
        <li><a href="/projet/view/evenement/frontoffice/liste_inscriptions.php" class="menu-link active"><i class="bi bi-card-checklist menu-icon"></i> Inscriptions</a></li>
      </ul>
    </aside>
    ...
    <div class="layout-page">
      <nav class="layout-navbar">
        <div class="navbar-search">
          <form method="GET" action="/projet/view/evenement/frontoffice/liste_inscriptions.php" id="searchForm">
            <div class="input-group">
              <span class="input-group-text"><i class="bi bi-search"></i></span>
              <input type="text" name="search" id="searchInput"
                     placeholder="Rechercher par ID inscription, utilisateur ou event..."
                     value="<?= $searchVal ?>" />
      ...
      <div class="content-wrapper">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="GET" action="/projet/view/evenement/frontoffice/liste_inscriptions.php" id="filterForm">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <a href="/projet/view/evenement/frontoffice/liste_inscriptions.php" class="btn btn-outline-secondary w-100">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form method="POST" action="">
        ...
        <input type="hidden" name="id" id="delete-registration-id">
        <div class="modal-header border-0 pb-0">
          <div class="d-flex align-items-center gap-2">
            <div style="width:40px;height:40px;border-radius:.5rem;background:#fff0ee;display:flex;align-items:center;justify-content:center">
              <i class="bi bi-trash" style="color:#ff3e1d;font-size:1.1rem"></i>
            </div>
            <h5 class="modal-title mb-0" id="deleteRegistrationModalLabel">Confirmer la suppression</h5>
          </div>
        ...
        <div class="modal-body pt-2">
          <p class="mb-2">
            ...
            <strong id="delete-registration-title" style="color:#566a7f"></strong> ?
          </p>
...
document.addEventListener('click', event => {
  ...
  document.getElementById('delete-registration-id').value = button.getAttribute('data-id');
  document.getElementById('delete-registration-title').textContent = title ? 'pour "' + title + '"' : '';
  new bootstrap.Modal(document.getElementById('deleteRegistrationModal')).show();
});
