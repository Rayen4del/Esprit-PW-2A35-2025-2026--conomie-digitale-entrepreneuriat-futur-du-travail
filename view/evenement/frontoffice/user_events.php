...
function renderPagination($currentPage, $totalPages, $search, $type) {
    ...
    $baseUrl = '/projet/view/evenement/frontoffice/user_events.php';
  ...
  <div class="layout-container">
    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item">
          <a href="/projet/view/evenement/frontoffice/user_events.php" class="menu-link active">
            <i class="bi bi-calendar-event menu-icon"></i> Événements
          </a>
        </li>
        <li class="menu-item">
          <a href="/projet/view/evenement/frontoffice/liste_inscriptions.php" class="menu-link">
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="user-actions">
          <a href="/projet/view/evenement/frontoffice/liste_inscriptions.php" class="btn btn-outline-primary">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="GET" action="/projet/view/evenement/frontoffice/user_events.php" id="filterForm">
              <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-2 d-grid">
                  <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='/projet/view/evenement/frontoffice/user_events.php'">
