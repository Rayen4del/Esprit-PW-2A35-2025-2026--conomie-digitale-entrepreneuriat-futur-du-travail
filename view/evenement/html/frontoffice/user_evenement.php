...
<div class="container">
  <div class="form-container">
    ...
    <div class="d-grid mt-3">
      <a href="/projet/view/evenement/html/frontoffice/user_events.php" class="btn btn-outline-primary">
    ...
    <a href="/projet/view/evenement/html/frontoffice/user_events.php" class="btn btn-outline-secondary mt-2">
    ...
    <form method="POST" action="">
      ...
      <div class="d-grid gap-2">
        ...
        <a href="/projet/view/evenement/html/frontoffice/user_events.php" class="btn btn-outline-secondary">
          <i class="bi bi-arrow-left me-1"></i> Retour aux événements
        </a>
      </div>
