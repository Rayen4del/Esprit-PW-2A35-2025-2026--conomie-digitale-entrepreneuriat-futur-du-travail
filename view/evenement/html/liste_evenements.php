    ...
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li class="menu-item open">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/projet/view/evenement/html/liste_evenements.php" class="menu-link active">
                <i class="bi bi-list-ul menu-icon"></i> Liste
              </a>
            </li>
            <li class="menu-item">
              <a href="/projet/view/evenement/html/form_evenement.php" class="menu-link">
    ...
    <div class="layout-page">
      ...
      <nav class="layout-navbar">
        <div class="navbar-search">
          <form method="GET" action="/projet/view/evenement/html/liste_evenements.php" id="searchForm">
      ...
      <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
          ...
          <a href="/projet/view/evenement/html/form_evenement.php" class="btn btn-primary btn-sm">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="GET" action="/projet/view/evenement/html/liste_evenements.php" id="filterForm">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <a href="/projet/view/evenement/html/liste_evenements.php" class="btn btn-outline-secondary w-100">
        ...
        <div class="text-center py-5">
          ...
          <a href="/projet/view/evenement/html/form_evenement.php" class="btn btn-primary mt-2">
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editForm" method="POST" action="/projet/view/evenement/html/liste_evenements.php" novalidate>
...
<script src="/projet/view/evenement/html/js/common.js"></script>
<script src="/projet/view/evenement/html/js/validate_rules.js"></script>
<script src="/projet/view/evenement/html/js/list_validation.js"></script>
<script>
    ...
    function openDeleteModal(id, title) {
        ...
        document.getElementById('deleteConfirmBtn').href =
            '/projet/view/evenement/html/liste_evenements.php?delete_id=' + id;
