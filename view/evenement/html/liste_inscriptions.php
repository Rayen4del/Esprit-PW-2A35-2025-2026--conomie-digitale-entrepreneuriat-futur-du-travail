  ...
  <div class="layout-container">
    <aside class="layout-menu">
      ...
      <ul class="menu-inner">
        ...
        <li><a href="/projet/view/evenement/html/user_events.php" class="menu-link"><i class="bi bi-calendar-event menu-icon"></i> Événements</a></li>
        <li><a href="/projet/view/evenement/html/liste_inscriptions.php" class="menu-link active"><i class="bi bi-card-checklist menu-icon"></i> Inscriptions</a></li>
      </ul>
    </aside>
